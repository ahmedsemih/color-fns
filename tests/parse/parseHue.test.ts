...
describe('parseHue', () => {
  it('should parse positive, negative, and large degree values', () => {
    ...
    expect(parseHue('450deg')).toBe(90);
  });
  ...
  it('should parse radian values and convert to degrees', () => {
    ...
    expect(parseHue('-1.5708rad')).toBeCloseTo(270);
  ...
  it('should parse gradian values and convert to degrees', () => {
    ...
    expect(parseHue('-100grad')).toBe(270);
    expect(parseHue('500grad')).toBe(90);
  });
  ...
  it('should parse turn values and convert to degrees', () => {
    ...
    expect(parseHue('-0.25turn')).toBe(270);
    expect(parseHue('1.5turn')).toBe(180);
  });
